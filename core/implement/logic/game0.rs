...
pub struct GameLogic < GameImpl : Default > {
    _game_impl: GameImpl,
    //todo
    _is_init: bool,
...
impl < GameImpl > IGameLogic for GameLogic < GameImpl > where GameImpl : Default {
    ...
    type GameImpl = GameImpl;

    fn new() -> GameLogic< GameImpl > {
